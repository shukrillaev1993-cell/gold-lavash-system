...
function getSpaCss() {
  var css = [
    ...
    '.logo-icon { width: 80px; height: 80px; background: linear-gradient(135deg, #F9A825, #F57F17);',
    '  border-radius: 20px; display: flex; align-items: center; justify-content: center;',
    '  margin: 0 auto 16px; font-size: 36px; box-shadow: 0 8px 32px rgba(249,168,37,.3); }',
